    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<RestaurantReview>()
              .HasData(
                 new RestaurantReview { Id = 1, Review = "The food was delicious", DinerId = 25, RestaurantId = 1 },
                 new RestaurantReview { Id = 2, Review = "Great Service", DinerId = 25, RestaurantId = 1 },
                 new RestaurantReview { Id = 3, Review = "yummy!", DinerId = 25, RestaurantId = 1 });
